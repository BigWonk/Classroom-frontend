...
export const SubjectsList = () =>
{
    ...
    const departmentFilters = selectedDepartment == "all" ? []: [{field: "department", operator: "eq" as const,
   ...
   const subjectTable = useTable<Subject>({
    columns: useMemo<ColumnDef<Subject>[]>(() => [
        ...
        },
        {
            ...
            cell: ({getValue}) => <span className="truncate line-clamp">{getValue<string>()}</span>,
        }
    ], []),
    refineCoreProps:{
        resource: "subjects",
